...
public final class FfmpegAudioRenderer extends SimpleDecoderAudioRenderer {
  private final String TAG = FfmpegAudioRenderer.class.getSimpleName();
  ...
  protected int supportsFormatInternal(
    ...
    } else if (format.sampleMimeType.endsWith("cook")) {
      Log.i(TAG, "choose cook renderer!");
  ...
  protected FfmpegAudioDecoder createDecoder(Format format, @Nullable ExoMediaCrypto mediaCrypto)
    ...
    Log.i(TAG, "FfmpegAudioDecoder create decoder!");
