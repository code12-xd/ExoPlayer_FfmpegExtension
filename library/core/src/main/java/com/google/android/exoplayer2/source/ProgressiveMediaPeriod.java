...
/* package */ final class ProgressiveMediaPeriod
  ...
  private final String TAG = ProgressiveMediaPeriod.class.getSimpleName();
    ...
    public void load() throws IOException, InterruptedException {
      ...
      while (result == Extractor.RESULT_CONTINUE && !loadCanceled) {
        ...
        try {
          ...
          Log.i("ExtractingLoadable", "length = " + length);
          if (length != C.LENGTH_UNSET) {
            length += position;
          }
          ...
          Log.i("ExtractingLoadable", "extrator = " + extractor.toString());
          ...
          Log.i("ExtractingLoadable", e.getMessage());
        } finally
        {
